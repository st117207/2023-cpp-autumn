...
public:
	...
	int GetttergetEdgesCountFromMatrix();
...
int main(int argc, char* argv[])
{
	...
	graph.ReadMatrix(n);
	std::cout << n << " ";
	std::cout << graph.GetttergetEdgesCountFromMatrix() << std::endl;
	graph.PrintEdges();
...
int CGraph::GetttergetEdgesCountFromMatrix()
{
	return getEdgesCountFromMatrix();
}
