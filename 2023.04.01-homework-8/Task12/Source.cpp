...
public:
	...
	bool AvailabilityLoops();
	bool NotSymmetricMatrix();
...
int main(int argc, char* argv[])
{
	...
	std::cin >> n;
	graph.ReadMatrix(n);
	if ((graph.AvailabilityLoops() == false) && (graph.NotSymmetricMatrix() == true))
	{
		std::cout << "YES";
	}
	else
...
bool CGraph::NotSymmetricMatrix()
{
	for (int i = 0; i < _vertexes; ++i)
	{
